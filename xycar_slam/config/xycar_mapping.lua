...
TRAJECTORY_BUILDER_2D.max_range = 14. --라이다 최대범위
...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_length = 0.5 --정한 수보다 큰 길이 제외
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 70 -- 1개의 서브맵을 만들때 사용할 라이다 개수
