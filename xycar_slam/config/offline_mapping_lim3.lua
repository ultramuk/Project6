...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_range = 46 --45 --50.
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.num_threads = 4 --8--4
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.25 --0.1 --0.3
...
POSE_GRAPH.global_constraint_search_after_n_seconds = 11 --12 --10.
