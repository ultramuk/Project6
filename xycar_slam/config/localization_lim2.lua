...
TRAJECTORY_BUILDER_2D.voxel_filter_size = 0.08 --0.025
...
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.min_num_points = 200 --100
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_range = 50.
TRAJECTORY_BUILDER_2D.use_online_correlative_scan_matching = true
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 0.001 --0.1
...
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.07 --0.2
...
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution = 0.049 --0.05
...
POSE_GRAPH.constraint_builder.min_score = 0.5 --0.35
